...
// require_once APP_PATH . 'helpers/generate_token.php';

/* Autoload for vendor */
require_once ROOT_PATH . 'vendor/autoload.php';
require_once ROOT_PATH . 'vendor/instagram/autoload.php';
require_once ROOT_PATH . 'vendor/instagramfeed/autoload.php';
require_once ROOT_PATH . 'vendor/oauth/autoload.php';
