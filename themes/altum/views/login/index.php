                    ...
                    <form action="" method="post" class="mt-4" role="form">
                        ...
                        <div class="row">
                            <?php if($this->settings->facebook->is_enabled): ?>
                                <div class="col-sm mt-1">
                                    <a href="<?= $data->facebook_login_url ?>" style="background:#4f81e9;" class="btn btn-success btn-block"><?= sprintf($this->language->login->display->facebook, "<i class=\"fab fa-fw fa-facebook\"></i>") ?></a>
                                </div>
                            <?php endif ?>
                        </div>
						...
						<div class="row">
                            <?php if($this->settings->google->is_enabled): ?>
                                <div class="col-sm mt-1">
                                    <a href="<?= $data->google_login_url ?>" style="background:#e14441;" class="btn btn-success btn-block"><?= sprintf($this->language->login->display->google, "<i class=\"fab fa-fw fa-google\"></i>") ?></a>
                                </div>
                            <?php endif ?>
                        </div>
