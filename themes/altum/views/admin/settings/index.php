...
<div class="row">
    <div class="mb-5 mb-xl-0 col-12 col-xl-3">
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link" href="#google" data-toggle="pill" role="tab"><i class="fab fa-fw fa-google fa-sm mr-1"></i> <?= $this->language->admin_settings->tab->google ?></a>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="main">
                            ...
                            <div class="form-group">
                                ...
                                <?php endif ?>
                                <input id="logo-file-input" type="file" name="logo" class="form-control form-control-lg" />
                            ...
                            <div class="form-group">
                                ...
                                <?php endif ?>
                                <input id="favicon-file-input" type="file" name="favicon" class="form-control form-control-lg" />
                        ...
                        <div class="tab-pane fade" id="payment">
                            ...
                            <div class="<?= !in_array($this->settings->license->type, ['SPECIAL','Extended License']) ? 'container-disabled' : null ?>">
                                ...
                                <p class="h5"><i class="fab fa-fw fa-paypal icon-paypal fa-sm mr-1 text-muted"></i> <?= $this->language->admin_settings->payment->paypal ?></p>
                                ...
                                <p class="h5"><i class="fab fa-fw fa-stripe icon-stripe fa-sm mr-1 text-muted"></i> <?= $this->language->admin_settings->payment->stripe ?></p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="business_zip" class="form-control form-control-lg" value="<?= $this->settings->business->zip ?>" />
                                    </div>
                        ...
                        <div class="tab-pane fade" id="captcha">
                            <p class="h5"><i class="fab fa-fw fa-google fa-sm mr-1 text-muted"></i> <?= $this->language->admin_settings->captcha->recaptcha ?></p>
                        ...
                        <div class="tab-pane fade" id="google">
                            <div class="form-group">
                                <label><?= $this->language->admin_settings->google->is_enabled ?></label>

                                <select name="google_is_enabled" class="form-control form-control-lg">
                                    <option value="1" <?= $this->settings->google->is_enabled ? 'selected' : null ?>><?= $this->language->global->yes ?></option>
                                    <option value="0" <?= !$this->settings->google->is_enabled ? 'selected' : null ?>><?= $this->language->global->no ?></option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->google->app_id ?></label>
                                <input type="text" name="google_app_id" class="form-control form-control-lg" value="<?= $this->settings->google->app_id ?>" />
                            </div>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->google->app_secret ?></label>
                                <input type="text" name="google_app_secret" class="form-control form-control-lg" value="<?= $this->settings->google->app_secret ?>" />
                            </div>
                        </div>
